...
const Rating = ({ likes, dislikes, reply }: Rating): JSX.Element => {
  const likeNum = likes.length;
  const dislikeNum = dislikes.length;

  return (
    <div className={s.commentRating}>
      <svg className={s.commentLikeImg} xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'>
        <defs />
      ...
      <svg className={s.commentDislikeImg} xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'>
        <defs />
      ...
      <svg className={s.commentReply} onClick={reply} xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'>
        <defs />
